    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            clearBtn.setOnClickListener {
                AlertDialog.Builder(this@PaintActivity).setTitle("Хотите очистить холст?")
                    ...
                    binding.seekBar.setOnSeekBarChangeListener(
                        object : SeekBar.OnSeekBarChangeListener {
                            override fun onProgressChanged(
                                ...
                                binding.brushSize.layoutParams.width =
                                    progress.toFloat().toInt() + 5
                                binding.brushSize.layoutParams.height =
                                    progress.toFloat().toInt() + 5
                            }
            ...
            saveBtn.setOnClickListener {
                ...
                Intent(this@PaintActivity, AddNoteActivity::class.java).apply {
